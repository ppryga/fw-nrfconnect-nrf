...
/**
 * @brief First (reference) antenna
 */
#define DFE_ANT1 12

/**
 * @brief Second antenna
 */
#define DFE_ANT2 1

/**
 * @brief Antenna distance
 */
#define DFE_ANT_D 0.05

/**
 * @brief Speed of the wavefront in m/s.
 *
 * Equals speed of light.
 */
#define WAVE_SPEED 299792458
